    ...
    render() {
            ...
            return (
                <div className="bg-gray-100 my-5 shadow-lg rounded-md relative">
                    ...
                    <div className='text-center text-lg font-medium py-10 lg:p-6'>
                        {
                            this.props.section === 'experience' ? <p className='text-lg'>{this.props.data.position} at {this.props.data.company}</p> : <p className='text-lg'>{this.props.data.degree} at {this.props.data.school}</p>
                        }
        ...
        return (
            <div className="bg-gray-100 my-5 shadow-lg rounded-md relative">
                ...
                <div className='text-center text-lg font-medium py-10 lg:p-6'>
                    <p className='text-lg font-medium'>{this.props.data.name}: {this.props.data.level}</p>
                </div>
            </div>
        )
    }
